...
import org.jusecase.jte.intellij.language.template.KteKotlinImportResolver;
...
public final class KteKotlinFragmentSemanticService {
    ...
    @Nullable
    public static SemanticType typeOfTypeText(@NotNull PsiElement sourceElement, @NotNull String typeText) {
    ...
    @Nullable
    public static PsiElement resolveReferenceAtTemplateRange(@NotNull JtePsiJavaInjection injection,
                                                             @NotNull TextRange rangeInElement) {
        KteKotlinFragmentContext context = context(injection);
        if (context == null) {
            return null;
        }

        KteKotlinFragmentPlace place = place(context, injection);
        if (place == null) {
            return null;
        }
    ...
    @Nullable
    private static KteKotlinFragmentContext context(@NotNull JtePsiJavaInjection injection) {
        KtePsiJavaContent host = PsiTreeUtil.getParentOfType(injection, KtePsiJavaContent.class, false);
        return host == null ? null : KteKotlinFragmentContext.from(host);
    }

    @Nullable
    private static KteKotlinFragmentPlace place(@NotNull KteKotlinFragmentContext context,
                                                       @NotNull JtePsiJavaInjection injection) {
        for (KteKotlinFragmentPlace place : context.places()) {
    ...
    @NotNull
    private static KtFile createFragmentFile(@NotNull KteKotlinFragmentContext context,
                                             @NotNull String text) {
    ...
    @Nullable
    private static PsiElement mapTargetBackToTemplate(@NotNull KteKotlinFragmentContext context,
                                                     @NotNull KteKotlinFragmentPlace place,
    ...
    @Nullable
    private static PsiElement parameterSourceElement(@NotNull KteKotlinFragmentContext context,
                                                    @NotNull String name) {
    ...
    @Nullable
    private static PsiElement importedSourceElement(@NotNull KteKotlinFragmentContext context,
                                                   @NotNull String name) {
