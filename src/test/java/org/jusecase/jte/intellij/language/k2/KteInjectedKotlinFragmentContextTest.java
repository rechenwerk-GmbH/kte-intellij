...
public class KteInjectedKotlinFragmentContextTest extends KteK2FixtureSupport {
    public void testCollectsOnlyCompletionRelevantKotlinFragments() {
        addProfileClassWithKotlinProperties();

        KteInjectedKotlinFragmentContext context = fragmentContext("""
    ...
    public void testBuildsImportsAndTemplateParameterLocals() {
        ...
        KteInjectedKotlinFragmentContext context = fragmentContext("""
                ...
                ${profile.displayName}
                """);
        KteInjectedKotlinFragmentPlace place = findPlace(context, "profile.displayName");
    ...
    public void testIncludesOnlyVisiblePreviousStatementLocals() {
        ...
        KteInjectedKotlinFragmentContext context = fragmentContext("""
                ...
                !{val future = first}
                """);
        KteInjectedKotlinFragmentPlace place = findPlace(context, "first.displayName");
    ...
    private KteInjectedKotlinFragmentContext fragmentContext(String text) {
        ...
        assertNotNull(host);
        return KteInjectedKotlinFragmentContext.from(host);
    }

    private KteInjectedKotlinFragmentPlace findPlace(KteInjectedKotlinFragmentContext context, String injectionText) {
